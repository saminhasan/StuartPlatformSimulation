function [] = motion_comp(out, trajectory, homeZ)
    ...
    plot(tsim(3:end) , azsim(3:end)/9.81, '-r', 'DisplayName', 'Simscape accZ');
    plot(time (3:end) ,ddz(3:end)/9.81, '-b', 'DisplayName', 'Setpoint accZ');
