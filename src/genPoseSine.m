function trajectory= genPoseSine(n)
    ...
    z = 0.04 * sin(2 * pi * 2 * f_trajectory * time)*0; % z (vertical component, up down)
    Rx = deg2rad(3.0)  * sin(2 * pi * f_trajectory * time)*0; % roll
    Ry = deg2rad(2.5)  * sin(2 * pi * 2 * f_trajectory * time)*0; % pitch
